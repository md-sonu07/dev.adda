                                ...
                                <tr key={post._id} className="hover:bg-box/30 transition-all group">
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p className="text-[13px] font-medium text-body line-clamp-1 group-hover:text-primary transition-colors uppercase tracking-tight">
                                                    {post.title || 'No Title'}
                                                </p>
                                                <div className="flex items-center gap-2 mt-1">
                                                    <span className="text-[9px] font-medium text-primary uppercase tracking-widest px-1.5 py-0.5 bg-primary/5 rounded">
                                    ...
                                    <td className="px-6 py-4 text-center">
                                        <div className="flex flex-col items-center gap-1">
                                            <span className={`px-2.5 py-1 text-[8px] font-medium uppercase tracking-[0.15em] rounded-full border flex items-center gap-1.5 transition-all duration-300 ${post.status === 'approved'
